...
public class MyService extends Service {
    ...
    private void playMedia(){
        ...
        createNotification("Cap Doi Dep Nhat", R.drawable.music_circle);
        startMediaplayer();
    }
    ...
    public void createNotification(String title, int d) {
        ...
        mRemoteViews.setTextViewText(R.id.text_song_name, title);
        mRemoteViews.setImageViewResource(R.id.text_song_author, d);
        ...
        mRemoteViews.setOnClickPendingIntent(R.id.image_back , pendingIntent1);
        mRemoteViews.setOnClickPendingIntent(R.id.image_pause , pendingIntent);
        mRemoteViews.setOnClickPendingIntent(R.id.image_next, pStopSelf);

        Notification.Builder notificationBuilder =
                new Notification.Builder(getApplicationContext());

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            mNotification = notificationBuilder.setSmallIcon(R.drawable.music_circle)
